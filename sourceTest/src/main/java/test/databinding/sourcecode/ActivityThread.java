...
public final class ActivityThread {
    ...
    final ArrayMap<String, WeakReference<com.weishop.test.sourcecode.LoadedApk>> mPackages
            = new ArrayMap<String, WeakReference<com.weishop.test.sourcecode.LoadedApk>>();
    final ArrayMap<String, WeakReference<com.weishop.test.sourcecode.LoadedApk>> mResourcePackages
            = new ArrayMap<String, WeakReference<com.weishop.test.sourcecode.LoadedApk>>();
    ...
    static final class ActivityClientRecord {
        ...
        com.weishop.test.sourcecode.LoadedApk packageInfo;
    ...
    static final class AppBindData {
        com.weishop.test.sourcecode.LoadedApk info;
        String processName;
        ApplicationInfo appInfo;
    ...
    Resources getTopLevelResources(String resDir, String[] splitResDirs, String[] overlayDirs,
            ...
            com.weishop.test.sourcecode.LoadedApk pkgInfo) {
    ...
    public final com.weishop.test.sourcecode.LoadedApk getPackageInfo(String packageName, CompatibilityInfo compatInfo,
                                                                      int flags) {
    ...
    public final com.weishop.test.sourcecode.LoadedApk getPackageInfo(String packageName, CompatibilityInfo compatInfo,
        ...
        synchronized (mResourcesManager) {
            WeakReference<com.weishop.test.sourcecode.LoadedApk> ref;
            if ((flags&Context.CONTEXT_INCLUDE_CODE) != 0) {
                ref = mPackages.get(packageName);
            } else {
                ref = mResourcePackages.get(packageName);
            }
            com.weishop.test.sourcecode.LoadedApk packageInfo = ref != null ? ref.get() : null;
    ...
    public final com.weishop.test.sourcecode.LoadedApk getPackageInfo(ApplicationInfo ai, CompatibilityInfo compatInfo,
                                                                      int flags) {
    ...
    public final com.weishop.test.sourcecode.LoadedApk getPackageInfoNoCheck(ApplicationInfo ai,
                                                                             CompatibilityInfo compatInfo) {
        return getPackageInfo(ai, compatInfo, null, false, true, false);
    }

    public final com.weishop.test.sourcecode.LoadedApk peekPackageInfo(String packageName, boolean includeCode) {
        synchronized (mResourcesManager) {
            WeakReference<com.weishop.test.sourcecode.LoadedApk> ref;
            if (includeCode) {
                ref = mPackages.get(packageName);
    ...
    private com.weishop.test.sourcecode.LoadedApk getPackageInfo(ApplicationInfo aInfo, CompatibilityInfo compatInfo,
        ...
        synchronized (mResourcesManager) {
            ...
            if (packageInfo == null || (packageInfo.mResources != null
                ...
                if (localLOGV) Slog.v(TAG, (includeCode ? "Loading code package "
                        ...
                        + ")");
                packageInfo =
                    new com.weishop.test.sourcecode.LoadedApk(this, aInfo, compatInfo, baseLoader,
                ...
                if (includeCode) {
                    mPackages.put(aInfo.packageName,
                            new WeakReference<com.weishop.test.sourcecode.LoadedApk>(packageInfo));
                } else {
    ...
    private void handleReceiver(ReceiverData data) {
        ...
        com.weishop.test.sourcecode.LoadedApk packageInfo = getPackageInfoNoCheck(
    ...
    private void handleCreateBackupAgent(CreateBackupAgentData data) {
        ...
        com.weishop.test.sourcecode.LoadedApk packageInfo = getPackageInfoNoCheck(data.appInfo, data.compatInfo);
    ...
    private void handleUpdatePackageCompatibilityInfo(UpdateCompatibilityData data) {
        com.weishop.test.sourcecode.LoadedApk apk = peekPackageInfo(data.pkg, false);
        if (apk != null) {
    ...
    private void setupGraphicsSupport(com.weishop.test.sourcecode.LoadedApk info, File cacheDir) {
    ...
    private void handleBindApplication(AppBindData data) {
        ...
        if (data.instrumentationName != null) {
            ...
            com.weishop.test.sourcecode.LoadedApk pi = getPackageInfo(instrApp, data.compatInfo,
