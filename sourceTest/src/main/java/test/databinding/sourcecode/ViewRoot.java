...
public final class ViewRoot extends Handler implements ViewParent,
    ...
    */
                ...
                if (focus.getGlobalVisibleRect(mVisRect, null)) {
                    ...
                    if (rectangle == null) {
                        ...
                        if (mView instanceof android.view.ViewGroup) {
                            ((android.view.ViewGroup) mView).offsetDescendantRectToMyCoords(
                                    focus, mTempRect);
                        }
    ...
    public void focusableViewAvailable(View v) {
        ...
        if (mView != null && !mView.hasFocus()) {
            ...
            boolean descendantsHaveDibsOnFocus =
                    (mFocusedView instanceof android.view.ViewGroup) &&
                        (((android.view.ViewGroup) mFocusedView).getDescendantFocusability() ==
    ...
    private static boolean isViewDescendantOf(View child, View parent) {
        ...
        return (theParent instanceof android.view.ViewGroup) && isViewDescendantOf((View) theParent, parent);
    }
            ...
            try {
                ...
                if (mView != null && mAdded && event != null) {
                    ...
                    if (!handled && isDown) {
                        ...
                        if (edgeFlags != 0 && mView instanceof android.view.ViewGroup) {
                            View nearest = FocusFinder.getInstance().findNearestTouchable(
                                    ((android.view.ViewGroup) mView), x, y, direction, deltas);
                            if (nearest != null) {
        ...
        if (mView != null) {
            if (mView.hasFocus()) {
                ...
                if (focused != null && !focused.isFocusableInTouchMode()) {
                    ...
                    final android.view.ViewGroup ancestorToTakeFocus =
     ...
     */
    private android.view.ViewGroup findAncestorToTakeFocusInTouchMode(View focused) {
        ViewParent parent = focused.getParent();
        while (parent instanceof android.view.ViewGroup) {
            final android.view.ViewGroup vgParent = (android.view.ViewGroup) parent;
            if (vgParent.getDescendantFocusability() == android.view.ViewGroup.FOCUS_AFTER_DESCENDANTS
    ...
    private boolean leaveTouchMode() {
        if (mView != null) {
            if (mView.hasFocus()) {
                ...
                mFocusedView = mView.findFocus();
                if (!(mFocusedView instanceof android.view.ViewGroup)) {
                    // some view has focus, let it keep it
                    return false;
                } else if (((android.view.ViewGroup)mFocusedView).getDescendantFocusability() !=
                        android.view.ViewGroup.FOCUS_AFTER_DESCENDANTS) {
                        ...
                        if (focused != null) {
                            ...
                            if (v != null && v != focused) {
                                ...
                                if (mView instanceof android.view.ViewGroup) {
                                    ((android.view.ViewGroup) mView).offsetDescendantRectToMyCoords(
                                            focused, mTempRect);
                                    ((android.view.ViewGroup) mView).offsetRectIntoDescendantCoords(
                                            v, mTempRect);
                                }
    ...
    public View focusSearch(View focused, int direction) {
        ...
        return FocusFinder.getInstance().findNextFocus((android.view.ViewGroup) mView, focused, direction);
    }
