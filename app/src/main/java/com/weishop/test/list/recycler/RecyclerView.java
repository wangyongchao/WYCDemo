...
import static com.weishop.test.list.recycler.AdapterHelper.Callback;
import static com.weishop.test.list.recycler.AdapterHelper.UpdateOp;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        //getOverScrollMode 滚动到尽头后的效果 OVER_SCROLL_NEVER没有效果
    ...
    protected void onAttachedToWindow() {
        ...
        System.out.println("RecyclerView onAttachedToWindow");
    ...
    protected void onDetachedFromWindow() {
        ...
        System.out.println("RecyclerView onDetachedFromWindow");
        if (mItemAnimator != null) {
            mItemAnimator.endAnimations();
        }
        mFirstLayoutComplete = false;
    ...
    public boolean onInterceptTouchEvent(MotionEvent e) {
        float xx = e.getX();
        float yy = e.getY();
        int intaction = e.getAction();
        String strAction = null;
        switch (intaction & MotionEvent.ACTION_MASK) {
        ...
        if (TestUtils.OPEN) {
            System.out.println("RecyclerView onInterceptTouchEvent action=" + strAction + ",x="
                    + xx + ",y=" + yy);
        }
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                mScrollPointerId = MotionEventCompat.getActionIndex(e);
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        if (TestUtils.OPEN) {
            System.out.println("RecyclerView onTouchEvent action=" + strAction + ",x="
                    + xx + ",y=" + yy);
        }
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        System.out.println("RecyclerView onMeasure");
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        System.out.println("RecyclerView onSizeChanged");
        if (w != oldw || h != oldh) {
            invalidateGlows();
        }
    }
    ...
    protected void removeDetachedView(View child, boolean animate) {
        System.out.println("RecyclerView removeDetachedView");
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        System.out.println("RecyclerView onLayout");
        eatRequestLayout();
    ...
    public void requestLayout() {
        System.out.println("RecyclerView requestLayout");
    ...
    public final class Recycler {
        ...
        private final List<ViewHolder>
                mUnmodifiableAttachedScrap = Collections.unmodifiableList(mAttachedScrap);//mUnmodifiableAttachedScrap集合不可增删改
        ...
        public View getViewForPosition(int position) {
            System.out.println("Recycler getViewForPosition position="+position);
