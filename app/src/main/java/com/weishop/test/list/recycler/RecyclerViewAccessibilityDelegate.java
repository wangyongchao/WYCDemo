 ...
 * <p>
 * This class handles basic accessibility actions and delegates them to
 * LayoutManager.
 */
public class RecyclerViewAccessibilityDelegate extends AccessibilityDelegateCompat {
    ...
    final AccessibilityDelegateCompat mItemDelegate = new AccessibilityDelegateCompat() {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            super.onInitializeAccessibilityNodeInfo(host, info);
            if (!shouldIgnore() && mRecyclerView.getLayoutManager() != null) {
                mRecyclerView.getLayoutManager().onInitializeAccessibilityNodeInfoForItem(host,
                        info);
            }
        }
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle args) {
            ...
            if (!shouldIgnore() && mRecyclerView.getLayoutManager() != null) {
                return mRecyclerView.getLayoutManager().performAccessibilityActionForItem(host,
                        action, args);
            }
            return false;
        }
