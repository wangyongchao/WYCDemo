...
import static com.weishop.test.list.recycler.RecyclerView.ViewHolder;
...
class AdapterHelper implements OpReorderer.Callback {
    ...
    final ArrayList<UpdateOp> mPendingUpdates = new ArrayList<UpdateOp>();//有待更新

    final ArrayList<UpdateOp> mPostponedList = new ArrayList<UpdateOp>();//延迟更新
