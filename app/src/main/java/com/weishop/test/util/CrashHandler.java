...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private static final String PATH =
            Environment.getExternalStorageDirectory().getPath() + File.separator + "crash";
...
//            e.printStackTrace();
//        }
        LogUtils.d("uncaughtException thread="+thread.getId());
        ex.printStackTrace();
    ...
    //将异常写入文件
    private void writeToSDcard(Throwable ex) throws IOException,
