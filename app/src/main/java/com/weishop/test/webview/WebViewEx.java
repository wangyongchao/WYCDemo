...
//        }
    ...
    private class WebChromeClientEx extends WebChromeClient {
        ...
        public final boolean onJsPrompt(WebView view, String url, String message,
            ...
            System.out.println("onJsPrompt url=" + url + "message="
                    + message + ",defaultValue=" + defaultValue + "，result=" + result);
    ...
    private class WebViewClientEx extends WebViewClient {
        ...
        public void doUpdateVisitedHistory(WebView view, String url, boolean isReload) {
            System.out.println("doUpdateVisitedHistory url =" + url + ",isReload=" + isReload);
            injectJavascriptInterfaces(view);
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            System.out.println("onPageStarted url =" + url + ",favicon=" + favicon);
            injectJavascriptInterfaces(view);
