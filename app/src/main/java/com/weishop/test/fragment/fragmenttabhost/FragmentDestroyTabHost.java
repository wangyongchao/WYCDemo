 ...
 * <p>
 * {@sample frameworks/support/samples/Support4Demos/src/main/java/com/example/android/supportv4
 * /app/FragmentTabs.java
 * complete}
 *
 * <p>This can also be used inside of a fragment through fragment nesting:
 * <p>
 * {@sample frameworks/support/samples/Support4Demos/src/main/java/com/example/android/supportv4/app
 * /FragmentTabsFragmentSupport.java
 * complete}
 */
public class FragmentDestroyTabHost extends TabHost
    ...
    public FragmentDestroyTabHost(Context context) {
    ...
    public FragmentDestroyTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onAttachedToWindow() {
        ...
        Log.d(TestUtils.TAG, "FragmentTabHost onAttachedToWindow");
        ...
        for (int i = 0, count = mTabs.size(); i < count; i++) {
            ...
            if (tab.fragment != null && tab.fragment.isAdded()) {
