...
public class GlideUtils {
    /*** 占位图 */
    public static int placeholderImage = R.drawable.ic_account;
    /*** 错误图 */
    public static int errorImage = R.drawable.ic_account;
    ...
    public static void loadCircleWithBorderImage(Context context, String url, ImageView imageView,
        ...
        RequestOptions options = RequestOptions.bitmapTransform(
                new MultiTransformation<>(
                        new CenterCrop(),
                        new CropCircleWithBorderTransformation(TestUtils.px2dip(context, borderSize), borderColor)
                ))
                .placeholder(placeholderImage) //占位图
                .error(errorImage);            //错误图
        Glide.with(context).load(url).apply(options).into(imageView);
    ...
    public static void loadRoundCircleImage(Context context, String url, ImageView imageView,
        ...
        RequestOptions options = RequestOptions.bitmapTransform(
                new MultiTransformation<>(
                        new CenterCrop(),
                        new RoundedCornersTransformation(TestUtils.px2dip(context, radius), 0,
    ...
    public static void loadRoundCircleImage(Context context, String url, ImageView imageView,
        ...
        RequestOptions options = RequestOptions.bitmapTransform(
                new MultiTransformation<>(
                        new CenterCrop(),
                        new RoundedCornersTransformation(TestUtils.px2dip(context, radius), 0, type)
                ))
                .placeholder(placeholderImage) //占位图
                .error(errorImage);            //错误图
        Glide.with(context).load(url).apply(options).into(imageView);
